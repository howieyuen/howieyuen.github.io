...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.da3cd4960388111bd0524527f6554ab36944e8f10d8367e09415249765a9e2fc.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e9eac932734ef89e30b169d8deec2a13104bc4a7f89b609327d3deadb1d0f3e6.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4823fcb42a5b279265996cc8817f37febd12e2ae846e3df57ebbceb6e3bb83ca.js',function(){input.required=false;search();});}

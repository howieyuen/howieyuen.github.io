...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c9e2286c790b3623673768bac83a3a02beddcd026d7fe3d45738463f78e599c7.js',function(){input.required=false;search();});}

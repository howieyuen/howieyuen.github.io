...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.806a7cdadd08b8088b4065a701f49fd784c35f47fca4500bcfd53df923b16525.js',function(){input.required=false;search();});}

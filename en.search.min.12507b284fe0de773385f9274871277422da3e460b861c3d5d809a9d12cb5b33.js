...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4b2bd1a814786f973f554e03d907995970ef2bfc9aa3e3ae4092133e0bfb72dd.js',function(){input.required=false;search();});}
